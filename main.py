...
def start_checking():
  ...
  while True:
    ...
    for card in cards:
      ...
      print(text)
      if 'minute' in text and int(text.split(' ')[0]) < max_minutes:
        return None
...
def login():
  ...
  driver.find_element_by_xpath('/html/body/main/main/section/div/div/div[1]/form/input[2]').send_keys('simon.broodje.kaas@gmail.com')
  driver.find_element_by_xpath('/html/body/main/main/section/div/div/div[1]/form/input[3]').send_keys('simonnomis8')
  time.sleep(.5)
